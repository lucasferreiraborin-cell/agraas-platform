...
export default function PublicNav() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-white/[.06] bg-[var(--sidebar-2)]/90 backdrop-blur-2xl">
      ...
      {open && (
        <div className="animate-[fadeIn_.2s_ease] border-t border-white/[.06] bg-[var(--sidebar-2)] px-6 pb-6 pt-4 md:hidden">
