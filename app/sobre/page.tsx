  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative isolate overflow-hidden">
        <img src="/images/lp/rebanho-nelore.png" alt="Boiada Nelore em pasto brasileiro" className="absolute inset-0 -z-10 h-full w-full object-cover" />
      ...
      <section className="relative isolate overflow-hidden px-6 py-28 text-center">
        <img src="/images/lp/Maquina-agricola-colheita.jpg" alt="" className="absolute inset-0 -z-10 h-full w-full object-cover" />
